...
class addDiamonditem extends StatefulWidget {
  const addDiamonditem({Key? key}) : super(key: key);

  @override
  State<addDiamonditem> createState() => _addDiamonditemState();
}

List<String> category = ['Ring', 'Necklace', 'Bracelet', 'Earring', 'Set'];

class _addDiamonditemState extends State<addDiamonditem> {
  String image_url = " ";
                  ...
                  buildButton(
                    ...
                    () {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(
                            'Diamond Item added successfully',
                            style: TextStyle(
                              color: Colors.white,
                              fontWeight: FontWeight.bold,
                            ),
