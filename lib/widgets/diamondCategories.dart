                  ...
                  children: [
                    ...
                    GestureDetector(
                      onTap: () {
                        ...
                        if (index == 0) {
                          Navigator.pushNamed(context, 'RingPage');
                        } else if (index == 1) {
                          Navigator.pushNamed(context, 'NecklacePage');
                        } else if (index == 2) {
                          Navigator.pushNamed(context, 'BraceletPage');
                        } else if (index == 3) {
                          Navigator.pushNamed(context, 'EarringPage');
                        } else if (index == 4) {
                          Navigator.pushNamed(context, 'SetPage');
                        }
                      },
                      child: Text(
                        dcategories[index].title,
